...
socket.on('message', function (message){
  ...
  if (message === 'got user media') {
	...
	console.log('Receiving geolocation: ', message.coords);
    createPositionOnMap(message.coords);
  }
});
...
// 
//
var isCarteEnable = false;
function showGeolocationOnGoogleMap(geolocation) {
...
function createPositionOnMap(crd) {
	...
	if (!isCarteEnable) {
		...
		var carte = new google.maps.Map(divCarte, options);
		divCarte.map=carte;
	}
